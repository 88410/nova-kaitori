...
export default function MemberResetPassword() {
  ...
  return (
    <LightPage>
      <PageHeader title={t('memberResetPasswordNav')} />

      <main className="mx-auto max-w-3xl px-3 py-4 sm:px-4 sm:py-10">
        <section className={`border-t-2 border-t-emerald-500 p-5 sm:p-9 ${lightPanelClass}`}>
            ...
            <form onSubmit={handleSubmit} className="mt-8 grid gap-5">
              {!isConfirmation && (
                <label className="grid gap-2">
                  ...
                  <div className="flex items-center gap-3 rounded-xl border border-slate-200 bg-[#f8f9fc] px-4 py-3 focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-100">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-xl bg-slate-950 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-emerald-700 disabled:bg-slate-300"
              >
                {isSubmitting
