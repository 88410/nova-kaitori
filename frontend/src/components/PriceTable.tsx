  ...
  return (
    <div className="border-b border-slate-200 last:border-b-0">
      <button
        ...
        className="flex w-full items-center gap-3 px-4 py-4 text-left transition-colors hover:bg-slate-50 sm:grid sm:grid-cols-[120px_minmax(0,1fr)_160px_24px] sm:gap-4"
      >
...
function ModelSection({ title, items }: { title: string; items: GroupedProduct[] }) {
  ...
  return (
    <section className="overflow-hidden rounded-lg border border-slate-200 bg-white">
      ...
      <div className="hidden border-b border-slate-200 bg-slate-50 px-4 py-2 text-xs font-medium uppercase tracking-wide text-slate-500 sm:grid sm:grid-cols-[120px_minmax(0,1fr)_160px_24px] sm:gap-4">
        <span>容量</span>
        <span>最高買取価格</span>
        <span>店舗名</span>
        <span />
